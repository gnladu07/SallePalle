    ...
    <div class="members-container">
        ...
        <div class="home-header">
            <div class="home-header-left">
                <h1>🧑‍🤝‍🧑 회원 관리</h1>
            	<p>전체 회원 조회 및 관리, 회원 정지/삭제, 권한 관리를 하실 수 있습니다.</p>
            </div>
	                ...
	                <tbody>
	                    <c:forEach var="m" items="${memberList}">
	                        <tr>
	                            ...
	                            <td>${m.nickname}</td>
	                            <td>${m.email}</td>
	                            <td><fmt:formatNumber value="${empty m.wallet_balance ? 0 : m.wallet_balance}" pattern="#,###" /></td>
    							<td><fmt:formatNumber value="${empty m.wallet_mileage ? 0 : m.wallet_mileage}" pattern="#,###" /></td>
