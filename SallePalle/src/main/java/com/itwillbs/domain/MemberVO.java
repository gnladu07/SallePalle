...
//	    toplct_id       INT NULL,                                -- 사용 안 함 (NULL 허용)
//	    address         VARCHAR(255) NOT NULL,                   -- 기본 주소 (카카오 API)
//	    detail_address  VARCHAR(255) NOT NULL,                   -- 상세 주소 입력값 (고객 직접 입력)
...
//	    notify_flag     CHAR(1) DEFAULT 'N' CHECK (notify_flag IN ('Y', 'N')), -- 알림 상태 플래그 (관리자 승인 알림 등에 사용)
...
//
//	    ob_access_token VARCHAR(500),
//	    ob_refresh_token VARCHAR(500),
//	    ob_user_seq_no VARCHAR(20),
//
...
public class MemberVO {
	...
	private String provider;				// 로그인 제공자(LOCAL/NAVER)	
